...
- Sentiment analysis over form / sheet data
- LLM-powered agentic workflow in n8n
...
- Reached the global **Finalist Crew**
- Performed under live-ranking pressure
...
> **Linux focus:** strong on file management & navigation, with working knowledge of network basics including IP address analysis.
...
+---------------------------------------------------------------+
|                                                               |
|   DATA SOURCE  --->  [ Trigger / Webhook Layer (n8n) ]---+    |
|                                                          |    |
|   USER INPUT   --->  [ LLM Reasoning + Agents       ]----+--> [ OUTPUT ]
|                                                          |    |
|   API / SHEET  --->  [ Validation + Structured Logic]----+    |
|                                                               |
...
_"Don't just build features. Build systems that outlive the sprint."_

_"The best product is one that makes itself obvious — no tutorial needed."_

_"Automate inefficient manual processes — don't just demonstrate concepts."_
...
<a href="https://www.linkedin.com/in/dhruv-sharma-24aa01269/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=30,24,20,12&height=120&section=footer" />
